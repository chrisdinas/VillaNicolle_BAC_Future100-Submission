    ...
    if (currentLocation > 1) {
        switch (currentLocation) {
            case 2:
                ...
                paper1.style.zIndex = 42;
                break;
            case 3:
                openBook();
                paper2.classList.remove("flipped");
                paper2.style.zIndex = 41;
                break;
            case 4:
                openBook();
                paper3.classList.remove("flipped");
                paper3.style.zIndex = 40;
                break;
            case 5:
                openBook();
                paper4.classList.remove("flipped");
                paper4.style.zIndex = 39;
                break;
            case 6:
                openBook();
                paper5.classList.remove("flipped");
                paper5.style.zIndex = 38;
                break;
            case 7:
                openBook();
                paper6.classList.remove("flipped");
                paper6.style.zIndex = 37;
                break;
            case 8:
                openBook();
                paper7.classList.remove("flipped");
                paper7.style.zIndex = 36;
                break;
            case 9:
                openBook();
                paper8.classList.remove("flipped");
                paper8.style.zIndex = 35;
                break;
            case 10:
                openBook();
                paper9.classList.remove("flipped");
                paper9.style.zIndex = 34;
                break;
            case 11:
                openBook();
                paper10.classList.remove("flipped");
                paper10.style.zIndex = 33;
                break;
            case 12:
                openBook();
